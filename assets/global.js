...
document.addEventListener('DOMContentLoaded', function () {
  const galleries = document.querySelectorAll('.pdp-hero');

  galleries.forEach(function (gallery) {
    const thumbs = gallery.querySelectorAll('.pdp-hero__thumb');
    const images = gallery.querySelectorAll('.pdp-hero__image');
    ...
    thumbs.forEach(function (thumb) {
      thumb.addEventListener('click', function () {
        ...
        images.forEach(function (img) {
          img.classList.toggle('is-active', img.dataset.mediaId === id);
        });
      });
    });
  });
